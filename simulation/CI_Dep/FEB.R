## This function provide the estimator of variances when provided with a sample variances for a given degress of freedom.
## argument:
##         sSq: Sample Variance
...
##
## output:
##        sigmaSq.hat: estimated value of variances.
