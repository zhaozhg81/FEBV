...
##      print( paste("t=",t,sep=""))
    ...
    L0<-round(cbind(tmse0.sSq, tmse0.ljs, tmse0.opt, tmse0.smy, tmse0.modified.smy, tmse0.vsh, tmse0.feb, tmse0.fes, tmse0.rebayes, tmse0.Feb ),3)
    L1<-round(cbind(tmse1.sSq, tmse1.ljs, tmse1.opt, tmse1.smy, tmse1.modified.smy, tmse1.vsh, tmse1.feb, tmse1.fes, tmse1.rebayes, tmse1.Feb),3)
    L2<-round(cbind(tmse2.sSq, tmse2.ljs, tmse2.opt, tmse2.smy, tmse2.modified.smy, tmse2.vsh, tmse2.feb, tmse2.fes, tmse2.rebayes, tmse2.Feb),3)
    Lp<-round(cbind(tmsep.sSq, tmsep.ljs, tmsep.opt, tmsep.smy, tmsep.modified.smy, tmsep.vsh, tmsep.feb, tmsep.fes, tmsep.rebayes, tmsep.Feb),3)
  
    Lsd0<-round(cbind(tmsd0.sSq, tmsd0.ljs, tmsd0.opt, tmsd0.smy, tmsd0.modified.smy, tmsd0.vsh, tmsd0.feb,  tmsd0.fes, tmsd0.rebayes, tmsd0.Feb),3)
    Lsd1<-round(cbind(tmsd1.sSq, tmsd1.ljs, tmsd1.opt, tmsd1.smy, tmsd1.modified.smy, tmsd1.vsh, tmsd1.feb,  tmsd1.fes, tmsd1.rebayes, tmsd1.Feb),3)
    Lsd2<-round(cbind(tmsd2.sSq, tmsd2.ljs, tmsd2.opt, tmsd2.smy, tmsd2.modified.smy, tmsd2.vsh, tmsd2.feb,  tmsd2.fes, tmsd2.rebayes, tmsd2.Feb),3)
    Lsdp<-round(cbind(tmsdp.sSq, tmsdp.ljs, tmsdp.opt, tmsdp.smy, tmsdp.modified.smy, tmsdp.vsh, tmsdp.feb,  tmsdp.fes, tmsdp.rebayes, tmsdp.Feb),3)
