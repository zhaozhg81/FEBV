...
concordance_colon <- function(numSim=500, PLOT=FALSE, bw="ucv")
  {
        ...
        for(i in 1:numSim)
          {
            ...
            idvec1=CVF(1, X_train_tumor, X_train_normal, X_valid_tumor, X_valid_normal, bw)
    ...
    boxplot(Crate1[,1],Crate1[,2],Crate1[,3],Crate1[,4],Crate1[,5],Crate1[,6],Crate1[,7],Crate1[,8],Crate1[,9],main="Rate of discordant pairs : Colon Cancer data", ylim=c(0.05,0.4), names=c("S^2","ELJS","TW","Smyth","Vash","f-EBV","f-EBVS","REBayes","F-EBV"),col=c("cyan3","blue","purple","green4","gold4", "brown","orange","green","red"),cex.lab=1.2,cex.axis=1.2,cex.main=1.5)
    dev.off()
